...
# Initialize dot start led
pixels = adafruit_dotstar.DotStar(board.APA102_SCK, board.APA102_MOSI, 1, brightness = 0.1)
...
def read_sequence(sequence):
    pixels.fill(green)
    for cap in sequence:
		# if the correct cap isn't pressed within 3 seconds
